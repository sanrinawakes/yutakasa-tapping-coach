...
container="yutakasa-full-rehearsal-cleanup-test-$$"
...
for file in scripts/support-migration-harness.sql \
  ...
  scripts/automation/ticket-full-auto-rehearsal-cleanup.sql \
  scripts/automation/ticket-full-auto-rehearsal-cleanup.sqlcheck.sql; do
...
echo 'Full auto rehearsal cleanup SQL: passed'

...
export default function ChatSidebar({
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="md:hidden fixed top-4 left-4 z-30 p-2.5 rounded-xl transition-all duration-200"
        style={{
        ...
        <div className="p-5" style={{ borderBottom: "1px solid var(--border-subtle)" }}>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-gold-gradient font-medium">AI Coach</p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-sm font-medium transition-all duration-200 text-white"
            style={{
            ...
            threads.map((thread) => {
              ...
              return (
                <div
                  ...
                  className="group relative flex items-center px-3 py-2.5 rounded-xl cursor-pointer transition-all duration-150"
                  style={{

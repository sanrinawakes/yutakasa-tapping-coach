...
describe("SupportPage", () => {
  ...
  it("keeps internal repair scenarios out of the customer ticket form", async () => {
    ...
    await user.type(screen.getByLabelText("件名"), "会話履歴が表示されない");
    expect(screen.getByLabelText("件名")).toHaveValue("会話履歴が表示されない");
  });
